//-------------------------------------------------------------------------------
// <copyright file="LinqToSqlWorkspaceFixture.cs" company="bbv Software Services AG">
    ...
    public class LinqToSqlWorkspaceFixture
    {
        ...
        public void AddEntity()
        {
            ...
            using (new TransactionScope())
            {
                ...
                //var comp = CompiledQuery.Compile((DataContext dataContext, string namePar) => {dataContext.GetTable<Person>().Where(p => p.Name == namePar));
                //var fetchedPerson = comp(((IWorkspace<DataContext>)this.Testee).WrappedInstance, name).First();
