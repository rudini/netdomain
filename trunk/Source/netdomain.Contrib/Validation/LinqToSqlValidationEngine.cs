//-------------------------------------------------------------------------------
// <copyright file="LinqToSqlValidationEngine.cs" company="bbv Software Services AG">
...
namespace netdomain.Contrib.Validation
{
    ...
    /// and the Metadata of the enitites in the <see cref="T:System.Data.Linq.DataContext"/>.
    /// </summary>
    public class LinqToSqlValidationEngine : IValidationEngine<ValidationResults>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinqToSqlValidationEngine"/> class.
        /// </summary>
        /// <param name="helper">The validation helper.</param>
        /// <param name="context">The context <see cref="T:System.Data.Linq.DataContext"/>.</param>
        public LinqToSqlValidationEngine(MetadataValidationHelper helper, DataContext context)
        {
