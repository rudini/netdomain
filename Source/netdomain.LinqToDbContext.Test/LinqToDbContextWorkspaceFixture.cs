//-------------------------------------------------------------------------------
// <copyright file="LinqToDbContextWorkspaceFixture.cs" company="bbv Software Services AG">
...
namespace netdomain.LinqToEntities.Test
{
    ...
    using netdomain.LinqToDbContext.Test.BusinessObjects;
    ...
    /// </summary>
    [TestFixture]
    public class LinqToDbContextWorkepaceFixture
    {
        ...
        public void SetUp()
        {
            ...
            { 
                ...
                "LinqTestEntities", 
                @"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\App_Data\DbContextTest.mdf;Integrated Security=True;User Instance=True")

                //new ConnectionStringSettings(
                //"LinqTestEntities", "Data Source=(local);Initial Catalog=DbContextTest;Integrated Security=True")
            };
            ...
            var context = new TestDbContext(
                this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString);
            context.Database.CreateIfNotExists();
            this.Testee = new LinqToDbContextWorkspace(context);
        ...
        public void AttachEntityToANewWorkspace()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var ctx1 = new TestDbContext(this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString);
                var ws1 = new LinqToDbContextWorkspace(ctx1);
        ...
        public void Include()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var query =
                    this.Testee.CreateQuery<Person>().Include(p => p.Adressliste.SelectMany(a => a.AdresseDetails));
        ...
        public void ConcurencyException()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var ctx2 = new TestDbContext(this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString);
                var ws2 = new LinqToDbContextWorkspace(ctx2);
