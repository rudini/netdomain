//-------------------------------------------------------------------------------
// <copyright file="LinqToEntitiesWorkspaceFixture.cs" company="bbv Software Services AG">
...
namespace netdomain.LinqToEntities.Test
{
    ...
    /// <summary>
    /// Summary description for LinqToEntitiesDataSourceUnitTest
    /// </summary>
    [TestFixture]
    public class LinqToEntitiesWorkspaceFixture
    {
        private Mock<IConfigurationManager> configurationManagerMock;

        public IWorkspace Testee { get; set; }

        public Mock<IWorkspaceBuilder> WorkspaceBuilderMock { get; set; }

        public Mock<IWorkspaceExtension> ExtensionMock { get; set; }
        ...
        public void SetUp()
        {
            ...
            { 
                ...
                "LinqTestEntities", 
                @"metadata=res://*/BusinessObjects.Model1.csdl|res://*/BusinessObjects.Model1.ssdl|res://*/BusinessObjects.Model1.msl;provider=System.Data.SqlClient;provider connection string='Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\App_Data\LinqTest.mdf;Integrated Security=True;User Instance=True'") 
            };

            this.configurationManagerMock.Setup(con => con.ConnectionStrings).Returns(connectionStringSettingsCollection);

            this.RegisterExtensions();
            this.Testee = new LinqToEntitiesWorkspace(new LinqTestEntities(this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString));
        }
        ...
        public void AddEntity()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var fetchedPerson = this.Testee.CreateQuery<PersonPoco>().Where(p => p.Name == name).First();
        ...
        public void DeleteEntity()
        {
            ...
            using (new TransactionScope())
            {
                ...
                fetchedPerson = this.Testee.CreateQuery<PersonPoco>().Where(p => p.Name == name).FirstOrDefault();
                var fetchedAddress = this.Testee.CreateQuery<AdressePoco>().Where(a => a.Name == address).FirstOrDefault();
        ...
        public void AttachEntityToANewWorkspace()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var ctx1 = new LinqTestEntities(this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString);
                var ws1 = new LinqToEntitiesWorkspace(ctx1);
        ...
        public void GetByKeyFromDb()
        {
            ...
            using (new TransactionScope())
            {
                ...
                var entityWithKey = new PersonPoco { Id = newPerson.Id };
        ...
        public void ConcurencyException()
        {
            ...
            using (new TransactionScope())
            {
                var person = new PersonPoco { Name = name, Beruf = profession };
                ...
                var ctx2 = new LinqTestEntities(this.configurationManagerMock.Object.ConnectionStrings["LinqTestEntities"].ConnectionString);
                var ws2 = new LinqToEntitiesWorkspace(ctx2);

                var person1 = ws1.CreateQuery<PersonPoco>().Where(p => p.Name == name).First();
                var person2 = ws2.CreateQuery<PersonPoco>().Where(p => p.Name == name).First();
                ...
                catch (OptimisticOfflineLockException ex)
                {
                    ...
                    var conflictedperson = (PersonPoco)ex.ConfictedObjects[0].Object;
        ...
        public void IsDirty()
        {
            ...
            var fetchedPerson1 = this.Testee.CreateQuery<PersonPoco>().Where(p => p.Name == name1).First();
            var fetchedPerson3 = this.Testee.CreateQuery<PersonPoco>().Where(p => p.Name == name3).First();
        ...
        public void NestedWorkspaceScope()
        {
            ...
            using (var scope = new WorkspaceScope(this.Testee))
            {
                ...
                var fetchedPerson = scope.CurrentWorkspace.CreateQuery<PersonPoco>().Where(p => p.Name == name).First();
                ...
                var changedPerson = scope.CurrentWorkspace.CreateQuery<PersonPoco>().Where(p => p.Id == newPerson.Id).First();
        ...
        public void CallOnSubmittingChangesOnWorkspaceExtension()
        {
            ...
            var name1 = "Testname1";
            var profession1 = "TestProfession1";
            var person1 = new PersonPoco { Name = name1, Beruf = profession1 };
            var person2 = new PersonPoco { Name = name1, Beruf = profession1 };
            var person3 = new PersonPoco { Name = name1, Beruf = profession1 };
        ...
        public void CallOnEntityAttachedOnWorkspaceExtension()
        {
            ...
            var name1 = "Testname1";
            var profession1 = "TestProfession1";
            var person1 = new PersonPoco { Id = id, Name = name1, Beruf = profession1 };
        ...
        private void SubMethodCallUsingWorkspaceScopeChangesName(string oldName, string newName)
        {
            ...
            {
                var fetchedPerson = scope.CurrentWorkspace.CreateQuery<PersonPoco>().Where(p => p.Name == oldName).First();
        ...
        private PersonPoco CreateANewEntity(string name, string profession, string address)
        {
            var newPerson = new PersonPoco
            {
                Name = name,
                Beruf = profession
            };

            var newAddress = new AdressePoco
            {
                Name = address
            };
